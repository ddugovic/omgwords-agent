...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('omgwords-agent', '0020_auto_20200420_2028'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='score_pbs', related_query_name='score_pb', to='omgwords-agent.User')),
            ],
        ),
        migrations.AddIndex(
            model_name='scorepb',
