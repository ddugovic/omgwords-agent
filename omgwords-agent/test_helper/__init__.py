...
from omgwords-agent.commands.command_context import *
from omgwords-agent.models import *
from omgwords-agent.util.memo import memoize, lazy
from .factories import *
from .discord import *
from .twitch import *
from .matchers import *
from omgwords-agent import discord, twitch
...
class Spec:
    ...
    def patches(self):
        return [
            patch("omgwords-agent.twitch.client", MockTwitchClient()),
        ]
